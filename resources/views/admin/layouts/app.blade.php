...
<div class="col-md-3">
            @include('admin.layouts.navigation') {{-- sidebar admin --}}
        </div>
                            @auth
            ...
            <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
                <div class="pt-2 pb-3 space-y-1">
                    ...
                    <x-responsive-nav-link :href="route('rooms.index')" :active="request()->routeIs('rooms.*')">Ruangan</x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('bookings.index')" :active="request()->routeIs('bookings.*')">Booking</x-responsive-nav-link>
                </div>
