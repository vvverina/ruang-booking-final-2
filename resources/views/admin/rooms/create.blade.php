            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('admin.rooms.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <div class="relative mt-1 rounded-md shadow-sm">
                                    ...
                                    <input type="text" name="price_per_hour" id="price_per_hour" class="block w-full rounded-md border-gray-300 pl-9 pr-12 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="0" value="{{ old('price_per_hour') }}">
                                </div>
                            ...
                            <div>
                                ...
                                <x-text-input id="floor" class="block mt-1 w-full" type="number" name="floor" :value="old('floor')" required />
                            ...
                            <div class="mt-2 grid grid-cols-2 md:grid-cols-4 gap-2">
                                @foreach(['Proyektor', 'AC', 'Whiteboard', 'Sound System', 'Koneksi Internet', 'Kursi Ergonomis', 'Meja Rapat', 'LED TV'] as $facility)
                                    <div class="flex items-center">
                                        <input id="facility-{{ Str::slug($facility) }}" name="facilities[]" type="checkbox" value="{{ $facility }}" class="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        ...
                        <div class="mb-6">
                            <div class="flex items-center">
                                <input id="is_available" name="is_available" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" checked>
