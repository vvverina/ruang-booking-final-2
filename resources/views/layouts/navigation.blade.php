        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (Auth::user()->AdminMiddleware() || Auth::user()->isManager())
                        <x-nav-link :href="route('admin.dashboard')" :active="request()->routeIs('admin.dashboard')">
                            {{ __('Admin Panel') }}
                        </x-nav-link>
                    @endif

                    <x-nav-link :href="route('rooms.index')" :active="request()->routeIs('rooms.index') || request()->routeIs('rooms.show')">
                        {{ __('Ruangan') }}
                    </x-nav-link>

                    <x-nav-link :href="route('bookings.index')" :active="request()->routeIs('bookings.index') || request()->routeIs('bookings.show') || request()->routeIs('bookings.create')">
                        {{ __('Booking Saya') }}
                    </x-nav-link>
